#the probability that the numbers will just randomly arrange themselves is very low (9!) so this method is very useless
...
def iterate(elements,add1,add2,add_sum):
	...
	curr_node = [add1,add2,add_sum,elements]
	curr_val = get_value(curr_node)
	while True:
		ele = curr_node[3]
		...
		node = [add1,add2,add_sum,elements]
